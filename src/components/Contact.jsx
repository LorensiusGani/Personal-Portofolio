    ...
    <div className="h-screen w-full bg-black pt-20">
      ...
      <div className='flex justify-center items-center mt-10'>
        <form action="" className='flex flex-col w-full md:w-1/2'>
          ...
          className=' p-2 bg-transparent border-4 text-white my-2'
          />
          <button className='bg-blue-500 text-black font-bold px-6 py-3 my-6 mx-auto rounded-xl cursor-pointer hover:scale-90 hover:bg-white hover:text-black duration-200'>Submit</button>
        </form>
      </div>
