  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-14 text-black bg-white fixed z-50">
      ...
      <ul className="hidden md:flex">
        <li className="px-5  cursor-pointer font-semibold hover:text-white hover:bg-black scale-105 duration-100"><a href="#home">Home</a></li>
        <li className="px-5  cursor-pointer font-semibold hover:text-white hover:bg-black scale-105 duration-100"><a href="#about">About</a></li>
        <li className="px-5  cursor-pointer font-semibold hover:text-white hover:bg-black scale-105 duration-100"><a href="#porto">Portofolio</a></li>
        <li className="px-5  cursor-pointer font-semibold hover:text-white hover:bg-black scale-105 duration-100"><a href="#contact">Contact</a></li>
      </ul>
